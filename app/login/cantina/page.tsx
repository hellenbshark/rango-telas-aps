    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slate-800 mb-2">Login Cantina</h1>
          <p className="text-slate-600">Acesse sua conta para gerenciar pedidos</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-600">
          Não tem conta?{" "}
          <Link href="/cadastro/cantina" className="text-green-500 hover:underline">
            Cadastre-se
          </Link>
        </p>
